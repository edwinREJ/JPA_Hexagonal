package co.edu.unicauca.asae.JpaHexagonal.infraestructura.output.controladorExepciones;
...
import co.edu.unicauca.asae.JpaHexagonal.infraestructura.output.controladorExepciones.estructuraExepciones.Error;
import co.edu.unicauca.asae.JpaHexagonal.infraestructura.output.controladorExepciones.estructuraExepciones.CodigoError;
import co.edu.unicauca.asae.JpaHexagonal.infraestructura.output.controladorExepciones.estructuraExepciones.ErrorUtils;
import co.edu.unicauca.asae.JpaHexagonal.infraestructura.output.controladorExepciones.exepcionesPropias.EntidadNoExisteException;
...
public class RestApiExceptionHandler {
        ...
        public ResponseEntity<Error> handleGenericException(final HttpServletRequest req,
                        final Exception ex, final Locale locale) {
                                System.out.println("fdfdfd: "+ex.getMessage());
